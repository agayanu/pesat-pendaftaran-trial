            ...
            <div class="modal-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Nama Pendek <div class="required">*</div></label>
                            <input type="text" class="form-control" name="short" required>
                            <div class="invalid-feedback">Nama Pendek Wajib Diisi!</div>
                        </div>
                    </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('hotline-tipe-perbarui') }}" method="post" class="validation-update" novalidate>
                @csrf
...
edit.addEventListener('show.coreui.modal', function (event) {
  ...
  var singkat = button.getAttribute('data-coreui-singkat');
  ...
  var modalBodySingkat = edit.querySelector('.modal-body #short');

  modalTitle.textContent = 'Edit ' + nama;
  modalBodyID.value = id;
  modalBodyNama.value = nama;
  modalBodySingkat.value = singkat;
});
