            ...
            <div class="modal-body">
                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Tipe <div class="required">*</div></label>
                            <select name="type" class="form-select" required>
                                <option value="">--pilih--</option>
                                @foreach ($hotlineType as $ht)
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Nomor <div class="required">*</div></label>
                            <input type="text" class="form-control" name="lines" required>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('hotline-perbarui') }}" method="post" class="validation-update" novalidate>
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Nomor <div class="required">*</div></label>
                            <input type="text" class="form-control" name="lines" id="lines" required>
                            <div class="invalid-feedback">Nomor Wajib Diisi!</div>
                        </div>
                    </div>
...
edit.addEventListener('show.coreui.modal', function (event) {
  ...
  var tipe = button.getAttribute('data-coreui-tipe');
  var nomor = button.getAttribute('data-coreui-nomor');
  ...
  var modalBodyTipe = edit.querySelector('.modal-body #type');
  var modalBodyNomor = edit.querySelector('.modal-body #lines');

  modalTitle.textContent = 'Edit ' + nama;
  modalBodyID.value = id;
  modalBodyNama.value = nama;
  modalBodyTipe.value = tipe;
  modalBodyNomor.value = nomor;
});
