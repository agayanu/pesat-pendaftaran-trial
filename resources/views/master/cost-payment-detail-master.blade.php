...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('biaya-pembayaran-rincian-master-perbarui') }}" method="post" class="validation-update" novalidate>
                @csrf
...
$(function () {        
    var table = $('#datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('biaya-pembayaran-rincian-master-data') }}",
        columns: [
            {  
                "data": null,
                "class": "align-top",
