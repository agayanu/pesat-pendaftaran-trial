                ...
                @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            ...
                            <input type="number" class="form-control" name="order" max="127" required>
                            <div class="invalid-feedback">Urutan tidak boleh kosong dan tidak lebih dari 127!</div>
                        </div>
                    </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('provinsi-perbarui') }}" method="post" class="validation-update" novalidate>
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Urutan <div class="required">*</div></label>
                            <input type="number" class="form-control" name="order" id="order" max="127" required>
                            <div class="invalid-feedback">Urutan tidak boleh kosong dan tidak lebih dari 127!</div>
                        </div>
                        <div class="col-sm-12 mb-3">
