...
<div class="card mb-3">
    <div class="card-header">
        <div class="d-flex justify-content-between">
            ...
            <button class="btn btn-sm btn-primary" type="button" data-coreui-toggle="modal" data-coreui-target="#meninggal">Meninggal</button>
        </div>
    </div>
    <div class="card-body">
...
<div class="modal fade" id="meninggal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pekerjaan-meninggal') }}" method="post" class="validation-create" novalidate>
                @csrf
                    <div class="row">
                        <div class="col-sm-12 mb-3">
                            <label class="form-label">Pilih nama pekerjaan yang menyatakan "meninggal" <div class="required">*</div></label>
                            <select name="job" class="form-select" required>
                                <option value="">--pilih--</option>
                                @foreach ($job as $j)
                                <option value="{{$j->id}}" {{$jd->id_job === $j->id ? 'selected' : ''}}>{{$j->name}}</option>
                                @endforeach
                            </select>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('pekerjaan-perbarui') }}" method="post" class="validation-update" novalidate>
                @csrf
